...
class BoardActivity : AppCompatActivity() {
    ...
    //variable para indicar el nivel seleccionado en el primer activity
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //creamos la variable intent para traer los datos del otro activity
        //realizamos una verificacion para evitar nulos y valores en blanco, asignando por defecto
        //el nivel facil.

        val intent = intent
        if (intent.getStringExtra("level")!="" && intent.getStringExtra("level")!=null){
    ...
    private fun takeaway() {
        ...
        //utilizamos la variable level, traida del primer activity, indicando el nivel seleccionado.
        val random = Random(System.currentTimeMillis())
        val numerosUnicos = mutableSetOf<Int>()

        while (numerosUnicos.size < level.toInt()) {
